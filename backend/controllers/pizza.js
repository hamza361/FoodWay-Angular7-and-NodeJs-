...
exports.getProducts = (req,res,next)=>{
    Pizza_Products.find().then((products)=>{
        if(!products){
...
exports.addProduct = (req,res,next)=>{
    ...
    const product = new Pizza_Products({name:name,imagePath:imagePath,price:price,description:description,category:category});
...
exports.deleteProduct = (req,res,next)=>{
    ...
    Pizza_Products.findOne({_id:_id}).then((product)=>{
        if(!product){
        ...
        return Pizza_Products.deleteOne({_id:_id});
   }).then((result)=>{
        if(result.n!=1){
...
exports.getProduct = (req,res,next)=>{
    ...
    Pizza_Products.findById({_id:_id}).then((product)=>{
...
exports.editProduct = (req,res,next)=>{
    ...
    Pizza_Products.updateOne({_id:_id},product).then((result)=>{
        if(!result){
